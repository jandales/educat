...
function Alert() {
        ...
        return (
            <div data-aos="fade-down" data-aos-delay="100" className="w-full bg-[#3966D826] py-4">
                <Container>
                    <div className="w-full px-4 flex items-center justify-center  md:text-center md:px-0">
